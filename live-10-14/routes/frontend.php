...
Route::get('get-time-slots', [FrontendController::class, 'getTimeSlot']);
...
Route::group(['middleware' => ['mode', 'XSS']], function () {
    ...
    Route::post('/event-time/check', [FrontendController::class, 'eventTimeCheck'])->name('event.time.check');
