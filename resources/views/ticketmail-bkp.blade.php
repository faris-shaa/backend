...
<body>
  <div class="ticket-container">
    <div class="header-section">
      <div style="display: table; width: 100%;">
        <div style="display: table-row; width: 100%;">
          <div class="" style="display: table-cell; width: 33.33%; text-align: left;">
            <p class="order-number outlined-text outline-shadow outline-layered outline-stroke">Ticket Number</p>
            <p class="order-number outlined-text outline-shadow outline-layered outline-stroke" style="margin-top:10px">{{ $order->order_id }}
            </p>
          </div>
          ...
          <div style="display: table-cell; width: 33.33%; text-align: right; vertical-align: middle;">
            <img src="https://ticketby.co/images/upload/6667236ab15c6.png" style="width:150px; height:50px;"
              alt="ticketby logo">
          </div>
        </div>
      </div>
    ...
    <div class="festival-banner text-center">
      <!-- <img src="{{ public_path('images/upload/' . $order->event->image) }}" alt="BANNER IMAGE"> -->
    ...
    <div class="table-container container">
      <div class="table-row">
        <div class="table-cell" style="width: 60%;">
          <p class="bold">{{ $order->customer->name }} {{ $order->customer->last_name }}</p>
          <p class="primary-color bold">{{ $order->event->start_time->format('M d') }} - {{
          ...
          <p class="event-description">{{ $order->event->location }}</p>

          <p class="event-title">Ticket Type</p>
          <p class="event-description">{{ $order->ticket_data[0]->ticket_type ?? 'Day one registration ticket' }}</p>
          <div style="margin-bottom: 0.5rem;">
            <p class="bold">dynamic type</p>
          </div>
        </div>
    ...
    <div class="container">
      <p style="color:#E52828; font-weight: bold; font-size: 16px;">Rules and Regulations</p>
    ...
    <div style="padding: 0 25px;">
      <div class="primary-color bold"
        style="margin: 1.5rem 0; padding: 15px; border-radius: 10px; font-size: 12px; text-transform: uppercase;">
