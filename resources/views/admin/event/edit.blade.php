                        ...
                        <div class="card-body">
                            <form method="post" class="event-form" action="{{ route('events.update', [$event->id]) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="terms_and_condition" Placeholder="{{ __('Terms & Condition') }}"
                                        class="textarea_editor @error('terms_and_condition')? is-invalid @enderror">
                                {{ $event->terms_and_condition }}
                            </textarea>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea name="terms_and_condition_arabic" Placeholder="{{ __('Terms & Condition Arabic') }}"
                                        class="textarea_editor @error('terms_and_condition_arabic')? is-invalid @enderror">
                                {{ $event->terms_and_condition_arabic }}
                            </textarea>
