        ...
        <div class="mb-4 col-span-4 bg-light bg-opacity-5 rounded-2xl border border-primary_color_o10_1 p-2 md:p-32-32 ">
            ...
            <div class="">
                <div class="flex flex-col py-4 border-t-1  border-b-1 border-dashed border-gray_6">
                    <button class="tab-button text-gray_b5  px-3 py-3 rounded-md focus:outline-none  text-h6 flex items-center gap-1 text-start @if (request('tab') == 'my-tickets') active @endif" data-tab="tab3">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button class="tab-button text-gray_b5  px-3 py-3 rounded-md focus:outline-none  text-h6 flex items-center gap-1 text-start @if (request('tab') == 'Favorites') active @endif" data-tab="tab5">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex flex-col mt-4">
                    <button class="tab-button flex items-center justify-center gap-1 text-gray_b5 px-2 py-3 rounded-md focus:outline-none  text-h6 @if (request('tab') == 'profile'|| request('tab') == 'Change_password') active @endif" data-tab="tab1">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class=" ">
                        <button class="tab-button  px-2 py-3  focus:outline-none  text-h6 bg-primary_color_8 text-white   rounded-md  w-full mt-4 md:mt-9" data-tab="tab2">{{__('Log out')}}</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="tab-content ">
                <div id="tab1" class="tab-pane hidden @if (request('tab') == 'profile'|| request('tab') == 'Change_password') active @endif">
                    ...
                    <div class="mb-4 flex border rounded-5xl border-primary_color_a11 justify-center md:w-fit mx-auto md:p-1 gap-1 w-full">
                        <button class="tab-button2 flex items-center justify-center gap-1 text-white px-3 md:px-2 py-3 rounded-5xl focus:outline-none  md:text-h6 text-h7 tab1 @if (request('tab') == 'profile') active @endif flex-1 md:flex-none" data-tab="tab6">
                            {{__('Profile settings')}}</button>
                    ...
                    <div class="tab-content2 ">
                        <div id="tab6" class="tab-pane2 tab1 hidden @if (request('tab') == 'profile') active @endif">
                            <form action="{{ url('update_user_profile') }}" method="post">
                                ...
                                <div class="text-end">
                                    <button
                                        class="bg-primary_color_8 text-white  px-5 py-2 rounded-6xl w-full md:w-56">{{ __('Save Changes') }}</button>
                                </div>
                            </form>
                        </div>
                ...
                <div id="tab2" class="tab-pane hidden  ">
                    <p class="text-h5 lg:text-h3  mb-4 font-medium"> {{__('Password')}}</p>
                </div>
                <div id="tab3" class="tab-pane hidden @if (request('tab') == 'my-tickets' || request('tab') == 'Past_events') active @endif">
                    <p class="text-h5 lg:text-h3  mb-4 font-medium"> {{__('My tickets')}}</p>
                    <div class="mb-4 flex border rounded-5xl border-primary_color_a11 justify-center w-fit mx-auto p-1 gap-1">
                        <button class="tab-button2 flex items-center justify-center gap-1 text-white px-2 py-3 rounded-5xl focus:outline-none  text-h6 tab3 @if (request('tab') == 'my-tickets') active @endif" data-tab="tab8">
                    ...
                    <div class="tab-content2 ">
                        <div id="tab8" class="tab-pane2  tab3 hidden   @if (request('tab') == 'my-tickets') active @endif ">
                            ...
                            <div class="grid grid-col-1 md:grid-cols-2  xl:grid-cols-3 gap-4 mt-4">
                                ...
                                <div class="bg-light bg-opacity-5 rounded-2xl border border-primary_color_o10_1 overflow-hidden">
                                    ...
                                    <div class="px-1">
                                        ...
                                        <div class="mt-2  mb-7 flex items-center justify-between">
                                            <div class="">
                                                <p class="flex gap-1  items-center mb-1">
                                                ...
                                                <p class="flex gap-1    items-center">
                                                    ...
                                                    <span class="text-h8 ">
                                                        {{ $lang == 'ar' ? Carbon\Carbon::parse($item['event']['start_time'])->translatedFormat('d M Y') : Carbon\Carbon::parse($item['event']['start_time'])->format('d M Y')}}
                                                    </span>
                                                </p>
                                            </div>
                                            <div>
                                                <a href="" class="bg-gray_35 rounded-lg text-light text-h8 flex items-center gap-1 py-1 px-2">
                                        ...
                                        <div class="py-2 border-t-1 border-dashed border-gray_fb round-tiket">
                                            <div class="bg-primary_color_2   rounded-lg w-32 h-32 mx-auto ">
                                                <img class="w-full h-full object-cover rounded-lg" src="{{$item['ticket_qr_code'][0]}}" alt="">
                                            </div>
                                            <div class="flex items-center gap-3 justify-center mt-4">
                                                <button data-model-id="{{ $item['id']}}" class="qr_open_model font-medium bg-primary_color_a11 hover:bg-gray_b12 rounded-full py-1 px-5">{{__('Show all')}}</button>
                                                <button class="bg-primary_color_a11 hover:bg-gray_b12 rounded-full w-9 h-9 flex items-center justify-center">
                                                    <svg width="13" height="15" viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M12.0344 8.78125L6.78439 14.2812C6.62814 14.4375 6.44064 14.5 6.25314 14.5C6.03439 14.5 5.84689 14.4375 5.69064 14.2812L0.440643 8.78125C0.159393 8.46875 0.159393 8 0.471893 7.71875C0.753143 7.4375 1.25314 7.4375 1.53439 7.75L5.50314 11.9062V1.28125C5.50314 0.84375 5.81564 0.53125 6.22189 0.53125C6.59689 0.53125 7.00314 0.84375 7.00314 1.28125V11.9062L10.9406 7.75C11.2219 7.4375 11.7219 7.4375 12.0031 7.71875C12.3156 8 12.3156 8.46875 12.0344 8.78125Z" fill="#FBF9FD" />
                                                    </svg>
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div id="{{ $item['id']}}" class="qr_model hidden pop-modal fixed inset-0 flex items-center justify-center bg-dark bg-opacity-75 p-2 z-50  ">
                                    <div class="bg-dark_4  rounded-2xl    relative w-w-700">
                                        <div class="p-2  md:p-32-32 mb-4 md:mb-7 flex items-center justify-between ">
                                            <h2 class="text-h4 md:text-h4 text-light font-medium"> {{ $item['event']['name']}}</h2>
                                            <span class=" close-modal  cursor-pointer">
                                        ...
                                        <div class="grid xl:grid-cols-3 grid-cols-2  px-1 ">
                                            @foreach($item['ticket_qr_code'] as $qr)
                                            <div class="p-2 md:p-4  md:p-4">
                                                <div class="border  border-primary_color_a11 bg-gray_f p-3 rounded-2xl">
                                                    <div class="xl:w-40 xl:h-40">
                                                        <img class="w-full h-full rounded-lg" src="{{$qr}}" alt="">
                                                    </div>
                                                    <div class="flex items-center md:gap-3  gap-1 justify-center mt-4">
                                                        <button data-model-id="{{ $item['id']}}" class="qr_open_model font-medium bg-primary_color_a11 hover:bg-gray_b12 rounded-full py-1 md:px-5 px-3 text-h6 md:text-h5">{{__('Show all')}}</button>
                                                        <button class="bg-primary_color_a11 hover:bg-gray_b12 rounded-full w-9 h-9 flex items-center justify-center">
                                                            <svg width="13" height="15" viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M12.0344 8.78125L6.78439 14.2812C6.62814 14.4375 6.44064 14.5 6.25314 14.5C6.03439 14.5 5.84689 14.4375 5.69064 14.2812L0.440643 8.78125C0.159393 8.46875 0.159393 8 0.471893 7.71875C0.753143 7.4375 1.25314 7.4375 1.53439 7.75L5.50314 11.9062V1.28125C5.50314 0.84375 5.81564 0.53125 6.22189 0.53125C6.59689 0.53125 7.00314 0.84375 7.00314 1.28125V11.9062L10.9406 7.75C11.2219 7.4375 11.7219 7.4375 12.0031 7.71875C12.3156 8 12.3156 8.46875 12.0344 8.78125Z" fill="#FBF9FD" />
                                                            </svg>
                            ...
                            <div
                                ...
                                <p class="text-h7 text-gray_6 w-2/4 mx-auto">{{__("It seems you haven't purchased any tickets yet. Once you do, your tickets will be displayed here.")}}</p>
                                <a href="/all-events" class="mt-4 mx-auto block bg-primary_color_8 text-white  md:text-h5  text-h6 px-5 md:px-14 py-2  md:rounded-6xl rounded-xl md:w-56">{{__('Explore Events')}}</a>
                            </div>
                            @endif
                        </div>
                ...
                <div id="tab5" class="tab-pane hidden  @if (request('tab') == 'Favorites') active @endif ">
                    <p class="text-h5 lg:text-h3  mb-4 font-medium"> {{__('Favorites')}}</p>
                    <div
                        class=" text-center">
                        <svg class="mx-auto" width="128" height="120" viewBox="0 0 128 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M11.2766 14.0379C10.4503 13.4008 9.47195 13.0909 8.50501 13.0909C7.16908 13.0909 5.84495 13.6759 4.96014 14.7939C3.42508 16.7288 3.76483 19.5265 5.72195 21.0414L6.73287 21.8247C6.80973 21.8204 6.88673 21.8182 6.96377 21.8182C7.83402 21.8182 8.71455 22.0996 9.45823 22.6781L109.358 100.779C109.879 101.186 110.273 101.696 110.533 102.256L116.721 107.051C118.69 108.572 121.514 108.224 123.038 106.295C124.573 104.361 124.233 101.563 122.276 100.048L119.726 98.0716C123.216 95.6312 125.499 91.5822 125.499 87V70.125C119.907 70.125 115.374 65.5919 115.374 60C115.374 54.408 119.907 49.875 125.499 49.875V33C125.499 25.5438 119.455 19.5 111.999 19.5H18.3256L11.2766 14.0379ZM95.867 100.5L87.233 93.75H17.499C13.777 93.75 10.749 90.722 10.749 87V75.4655C16.7042 72.8568 20.874 66.9065 20.874 60C20.874 53.0935 16.7042 47.1427 10.749 44.534V33.9551L4.56478 29.1203C4.19675 30.349 3.99902 31.6514 3.99902 33V49.875C9.59098 49.875 14.124 54.408 14.124 60C14.124 65.5919 9.59098 70.125 3.99902 70.125V87C3.99902 94.4558 10.0432 100.5 17.499 100.5H95.867ZM30.999 49.7865V73.5C30.999 77.2277 34.0213 80.25 37.749 80.25H69.9651L61.3311 73.5H37.749V55.0636L30.999 49.7865ZM53.1702 46.5L88.0148 73.5H91.749V46.5H53.1702ZM98.499 73.5C98.499 75.8959 97.2507 78.0004 95.3688 79.1983L113.825 93.4992C116.663 92.701 118.749 90.0896 118.749 87V75.4655C112.794 72.8568 108.624 66.9065 108.624 60C108.624 53.0935 112.794 47.1427 118.749 44.534V33C118.749 29.278 115.721 26.25 111.999 26.25H27.0368L44.4591 39.75H91.749C95.4771 39.75 98.499 42.7719 98.499 46.5V73.5Z" fill="#312C35" />
                        ...
                        <p class="text-h6 mb-1 mt-4">
                            {{ __('Sorry, you have no favorites saved') }}
                        </p>
                        <p class="text-h7 text-gray_6">{{__("To add a favorites, simply tap the heart on any item.")}}</p>
                        <a href="/all-events" class="mt-4 mx-auto block bg-primary_color_8 text-white  md:text-h5  text-h6 px-5 md:px-14 py-2  md:rounded-6xl rounded-xl md:w-56">{{__('Explore Events')}}</a>
                    </div>
                </div>
            </div>
...
<script script>
    $(document).ready(function() {
        $('.qr_open_model').on('click', function() {
            var modelId = $(this).data('model-id');

            $(`#${modelId}`).removeClass('hidden');
        })
    })
